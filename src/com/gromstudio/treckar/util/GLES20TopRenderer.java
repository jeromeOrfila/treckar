...
public class GLES20TopRenderer extends GLES20Renderer implements GeolocationListener, OnCompassChangedListener  {
	...
	static final float TOP_VIEW_FACTOR = 0.02f * CoordinateConversions.RADIUS;
	
	Compass mCompass;
	public static final boolean TEST = true;
	
	public GLES20TopRenderer(Context context) {
	...
	protected float[] getViewMatrix() {
		...
		if ( TEST ) {
			...
			float[] geod = new float[] {45.1555234f, 5.63582604f, 0.02f*TOP_VIEW_FACTOR} ;
	...
	protected float[] getProjectionMatrix(int width, int height) {
		...
		float diam = 0.02f*TOP_VIEW_FACTOR;
		...
		final float near = .5f*TOP_VIEW_FACTOR;
